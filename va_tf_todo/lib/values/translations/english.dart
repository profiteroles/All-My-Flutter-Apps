const Map<String, String> english = {
  ...
  "synchronise_text": "This will transfer all of your task list to our cloud so you could access it from any device when you login",
  "task": "Task",
  "tasks": "Tasks",
  "task_list_type": "Task List Type",
